<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img src="https://images.unsplash.com/photo-1637682184683-74e6d34ed72d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=327&q=80" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center" />
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Ready to discover your next favorite book?</h2>
...
Search
        ...
        <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-blue-600 font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
  ...
  <script setup>
  const links = [
    { name: 'Get reccomendation', href: '/home' },
    { name: 'View Project on Github', href: 'https://github.com/ckimatu/moodreads' },
