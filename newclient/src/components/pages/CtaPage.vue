<template>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <!-- Background image -->
      <img src="https://images.unsplash.com/photo-1530819568329-97653eafbbfa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=865&q=80" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center" />
...
<!-- </p> -->
  ...
  <script setup>
  const links = [
    { name: 'Get recommendations', href: '/home' },
